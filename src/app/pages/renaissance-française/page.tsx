...
import chambord from "@/assets/histoire_art/chambord.jpg"
import charles8 from "@/assets/histoire_art/charles_8.png"
import louis12 from "@/assets/histoire_art/louis_12.jpg"
import francois1 from "@/assets/histoire_art/francois_1.jpg"
import armoirette from "@/assets/histoire_art/facade_armoirette.jpg"
import fleuron from "@/assets/histoire_art/fleuron.jpg"
import intarsia from "@/assets/histoire_art/intarsia.jpg"
import coffre from "@/assets/histoire_art/coffre_fr.jpg"
import armoire from "@/assets/histoire_art/armoire_fr.jpg"
import dressoir from "@/assets/histoire_art/dressoir_fr.jpg"
import lit from "@/assets/histoire_art/lit_fr.jpg"
import cabinet from "@/assets/histoire_art/cabinet_fr.jpg"
...
export default function RenaissanceFrançaise () {

    const [focusState, setFocus] = useState(<></>)
    const [zoomState, setZoom] = useState(false)
    const [zoomSrc, setSrc] = useState(lit)
    ...
    return (
        <div className={styles.histoireArtCours}>
            ...
            <h1 className={styles.histoireArtCoursTitle}>La <i>Renaissance Française</i> du XVᵉ au XVIᵉ siècle</h1>
            <div className={styles.coursContent}>
                ...
                <div id="architecture" className={styles.partieCours}>
                    ...
                    <div className={styles.titusThermes}>
                        <Image src={chambord} alt="Photo du chateau de chambord" className={styles.imageCentre} />
                        <div className={[styles.imgSubtitle, styles.centerText].join(' ')}>CHÂTEAU DE CHAMBORD</div>
                    </div>
                    <p>
                    ...
                    <br />
                    <p>
                        Lors des campagnes d'Italie de <span className={styles.tooltip}  onMouseOver={() => {
                    ...
                    }}>Charles VIII</span>, <span className={styles.tooltip} onMouseOver={() => {
                    ...
                    }}>Louis XII</span> et <span className={styles.tooltip} onMouseOver={() => {
                ...
                <div id="decorations" className={styles.partieCours}>
                    ...
                    <p>
                        ...
                        vogue ; ils forment des encadrements de panneaux et se combinent avec les <span className={styles.tooltip} onMouseOver={() => {
                    ...
                    <Image src={armoirette} alt="Façade Armoirette renaissance" className={styles.smallImg}/>
                    <div className={[styles.imgSubtitle, styles.centerText].join(' ')}>Façade d'armoirette à suspendre d'époque Renaissance</div>
                </div>
                ...
                <div id="mobilier" className={styles.partieCours}>
                    ...
                    <p>
                        On voit apparaître « <span className={styles.tooltip} onMouseOver={() => {
                    ...
                    <ol>
                        <li>
                            <span className={styles.tooltip} onMouseOver={() => {
