...
export default function Directoire() {

    const [focusState, setFocus] = useState(<></>)
    const [zoomState, setZoom] = useState(false)
    const [zoomSrc, setSrc] = useState(priseBastille)
    ...
    return (
        <div className={styles.histoireArtCours}>
            ...
            <h1 className={styles.histoireArtCoursTitle}>Le <i>Style Directoire</i> de 1789 à 1804</h1>
            <div className={styles.coursContent}>
                ...
                <div id="mobilier" className={styles.partieCours}>
                    ...
                    <div className={styles.titusThermes}>
                        <Image className={styles.imageCentre} src={meridienneJacob} alt="Mérdienne des frères Jacob" />
                        <p className={[styles.imgSubtitle, styles.centerText].join(' ')}><i>Méridienne en Acajou</i> réalisation des frères Jacob</p>
                    </div>
                    <p>
                ...
                <div id="conclusion" className={styles.partieCours}>
                    <h2>Conclusion</h2>
                    <p>
