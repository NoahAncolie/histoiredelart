...
export default function StyleEmpire () {
    const [focusState, setFocus] = useState(<></>);
    const [zoomState, setZoom] = useState(false);
    const [zoomSrc, setSrc] = useState(napoleon);
    ...
    return (
        <div className={styles.histoireArtCours}>
            ...
            <h1 className={styles.histoireArtCoursTitle}>Le <i>Style Empire</i> de 1804 à 1815</h1>
            <div className={styles.coursContent}>
                ...
                <div id="tissus" className={styles.partieCours}>
                    <h2>Tissus</h2>
                </div>
