...
export default function StyleLouisXIII () {
    const [focusState, setFocus] = useState(<></>);
    const [zoomState, setZoom] = useState(false);
    const [zoomSrc, setSrc] = useState(placage13);
    ...
    return (
        <div className={styles.histoireArtCours}>
            {zoomState ? <div className={styles.bigImg}>
                ...
                <Image src={zoomSrc} alt="zoomState"/>
            </div> : <></>}

            <h1 className={styles.histoireArtCoursTitle}>Le <i>Style Louis XIII</i> de 1589 à 1650</h1>
            <div className={styles.coursContent}>
                ...
                <div id="historique">
                    <h2>Historique</h2>
                    <p>
                        Le style Louis XIII s'étend environ de 1610 à 1643, recouvrant les règnes d’ <span className={styles.tooltip} onMouseOver={() => {
                        setFocus(
                    ...
                    }} >Henri IV</span> et <span className={styles.tooltip} onMouseOver={() => {setFocus(
                ...
                <div id="architecture" className={styles.partieCours}>
                    ...
                    <div className={styles.titusThermes}>
                        <Image className={styles.imageCentre} src={chateau13} alt="France Eure Chateau de Beaumesnil" />
                        <p className={[styles.imgSubtitle, styles.centerText].join(' ')}><u>CHÂTEAU BEAUMESNIL DANS L'EURE</u> <i>Style Louis XIII</i></p>
                    </div>
                    <p>
                        Le style se caractérise par des constructions en briques avec chaînages en pierre et de hautes toitures souvent ornées de pots à feu. L’influence gréco-romaine est notable, avec un usage libre des ordres classiques. Vers la fin de l’époque, les combles brisés apparaissent, dits <span className={styles.tooltip} onMouseOver={() => {
                    ...
                    <Image src={françoisMansart} alt="François Mansart Portrait" className={styles.smallImg}/>
                    <p className={[styles.imgSubtitle, styles.centerText].join(' ')}>François Mansart</p>
                ...
                <div id="decorations" className={styles.partieCours}>
                    ...
                    <ul>
                        <li><span className={styles.tooltip} onMouseOver={() => {
                    ...
                    <Image src={pointeGateau} alt="Armoire en Pointe de Gateau et tas de Sable" className={styles.smallImg} />
                    <p className={[styles.imgSubtitle, styles.centerText].join(' ')}>Panneaux en tas de sable et pointe de gateau</p>
                    <div className={styles.titusThermes}>
                        <Image className={styles.imageCentre} src={tournage} alt="exemples de pieds tournés Louis XIII" />
                    </div>
                </div>
                ...
                <div id="mobilier" className={styles.partieCours}>
                    ...
                    <div className={styles.titusThermes}>
                        <Image className={styles.imageCentre} src={cabinet13} alt="Cabinet de style Louis XIII" />
                        <p className={[styles.imgSubtitle, styles.centerText].join(' ')}>CABINET LOUIS XIII &nbsp; <span className={styles.tooltip} onMouseOver={() => {
                ...
                <div className={styles.partieCours} id="artistes">
                    <h2>Les Artistes</h2>
                    <ul>
